    ...
    return (  
      ...
      <div className="card mb-5 mb-lg-0">
        <div className="card-body">
          <h4 className="card-title text-muted text-uppercase text-center">Plus</h4>
          <h1 className="card-price text-center">$9<span className="period">/month</span></h1>
          <hr/>
          <ul className="fa-ul">
          ...
          <button className="btn btn-primary text-uppercase" disabled>Button</button>
          </div>
        </div>
      </div>
    </div>
