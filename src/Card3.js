    ...
    return (  
      ...
      <div className="card">
        <div className="card-body">
          <h4 className="card-title text-muted text-uppercase text-center">Pro</h4>
          <h1 className="card-price text-center">$49<span className="period">/month</span></h1>
          <hr/>
          <ul className="fa-ul">
            <li ><span className="fa-li"><i className="fas fa-check"></i></span>Unlimited Users
            </li>
            ...
            <li ><span className="fa-li"><i className="fas fa-check"></i></span>Unlimited Free
              Subdomains</li>
